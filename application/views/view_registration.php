                        ...
                        <form class="appnitro"  id="register_form" method="post" action="<?php echo site_url() ?>registration/register_user">
                            ...
                            <ul >
                                ...
                                <li id="li_1" >
                                    ...
                                    <div>
                                        <select class="element select medium" id="element_8" name="country"> 
                                ...
                                <li id="ccc">
                                    ...
                                    <div>
                                        ...
                                        <ul>
                                            <li>
                                                <select name="card_brand" class="cards">
                                                <option value="visa">Type of Card</option>
                                            ...
                                            <li class="vertical maestro">
                                                <ul>
                                                    <li>
                                                        <label for="issue_date">Issue date <small>mm/yy</small>  (if your card doesn't have one leave this blank)</label>
                                                        <input type="text" name="issue_date" id="issue_date" maxlength="5">
                                                    </li>

                                                    <li>
                                                        <span class="or">or</span>
                                                        <label for="issue_number">Issue number (if your card doesn't have one leave this blank)</label>
                                            ...
                                            <li>
                                                ...
                                                <input type="text" size="35" name="name_on_card" id="name_on_card">
                                            </li>
                                ...
                                <li class="buttons">
                                    <input type="hidden" name="form_id" value="806579" />
